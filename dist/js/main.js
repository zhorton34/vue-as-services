...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return VueServices; });
...
function () {
  function VueServices() {
    ...
    _classCallCheck(this, VueServices);
    ...
    if (container) {
      ...
      var rootInstanceOptions = container.rootInstance || {
        options: {}
      };
      var RootInstance = this.RootInstance;
      this.RootInstance.options = _objectSpread({}, RootInstance.options, {}, rootInstanceOptions);
    }
  }
  /**
  ...
  _createClass(VueServices, [{
    ...
    value: function launch() {
      ...
      this.register(); // boot callbacks depend on internally registered properties on MercatorAdmin
      ...
      this.app = new vue__WEBPACK_IMPORTED_MODULE_0___default.a(this.RootInstance.options);
    }
  }]);
...
module.exports = __webpack_require__(/*! /Users/zhorton/repos/vue/vue-as-services/src/main.js */"./src/main.js");
